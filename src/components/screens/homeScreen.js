        ...
        <View style={Style.subContainer}>
          ...
          <View style={Style.mainview}>
            <View style={Style.headerView}>
              ...
              >
                <Text style={Style.SellText}>{"Rent"}</Text>
              </TouchableOpacity>
            </View>
            <TouchableOpacity
            ...
            >
              <View style={Style.searchbarView}>
                <Text style={Style.serchText}>{"search"}</Text>
              </View>
            </TouchableOpacity>
          </View>
        </View>
